  ...
  Future<Result<String>> createCalendar(
    ...
    return _invokeChannelMethod(
      ...
      arguments: () => <String, Object?>{
        ...
        ChannelConstants.parameterNameCalendarColor: calendarColor?.toARGB32().toRadixString(16),
  ...
  Future<bool> updateCalendarColor(Calendar calendar,
    ...
    final result = await _invokeChannelMethod(
      ...
      arguments: () => <String, dynamic>{
        ...
        ChannelConstants.parameterNameCalendarColor: color?.toARGB32().toRadixString(16),
      },
    );
